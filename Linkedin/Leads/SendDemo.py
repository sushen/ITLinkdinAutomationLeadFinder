...
#Change the messages as you wish, one of them will be randomly picked
messages = [
    "মানুষ যেভাবে কাজ করে আমি সেভাবেই টুলটা বানিয়েছি। কিছুদিনের মধ্যেই সমস্ত সামাজিক মাধ্যম তাদের এ পি আই এর মাধ্যমে যোগাযোগ করাকে খুবেই সিমিত করে দেবে। আমার টুলটা যেহেতু মানুষের মত কাজ করে আপনাকে সামাজিক মাধ্যমগুলোর ফায়ারওয়াল রুল আটকাতে পাড়বে না। আপনার কাছে যদি সেল করার মত প্রডাক্ট না থাকে আমি প্রডাক্টও সরবরাহ করতে পাড়ি।  ডেমো লিংক : https://youtu.be/VHaaI_XINsY ",
    "কিছুদিনের মধ্যেই সমস্ত সামাজিক মাধ্যম তাদের এ পি আই এর মাধ্যমে যোগাযোগ করাকে খুবেই সিমিত করে দেবে। মানুষ যেভাবে কাজ করে আমি সেভাবেই টুলটা বানিয়েছি। আমার টুলটা যেহেতু মানুষের মত কাজ করে আপনাকে সামাজিক মাধ্যমগুলোর ফায়ারওয়াল রুল আটকাতে পাড়বে না। আপনার কাছে যদি সেল করার মত প্রডাক্ট না থাকে আমি প্রডাক্টও সরবরাহ করতে পাড়ি।  ডেমো লিংক : https://youtu.be/VHaaI_XINsY ",
    "আমার টুলটা যেহেতু মানুষের মত কাজ করে আপনাকে সামাজিক মাধ্যমগুলোর ফায়ারওয়াল রুল আটকাতে পাড়বে না। মানুষ যেভাবে কাজ করে আমি সেভাবেই টুলটা বানিয়েছি। কিছুদিনের মধ্যেই সমস্ত সামাজিক মাধ্যম তাদের এ পি আই এর মাধ্যমে যোগাযোগ করাকে খুবেই সিমিত করে দেবে। আপনার কাছে যদি সেল করার মত প্রডাক্ট না থাকে আমি প্রডাক্টও সরবরাহ করতে পাড়ি।  ডেমো লিংক : https://youtu.be/VHaaI_XINsY "
...
driver = webdriver.Chrome("E:\\Python\\Project\\ITLinkdinAutomationLeadFinder\\chromedriver.exe"
...
url = "https://www.linkedin.com/sales/lists/people/6726809509014118400"
...
list_to_remove = "Lead Automation Demo"

list_to_add = "Lead Automation Demo 2"
